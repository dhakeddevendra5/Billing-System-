...
public class Login extends JFrame {
	...
	private JLabel lblDevendrLogin;
	JButton btnLogin;
...
//					Process process = Runtime.getRuntime().exec("E:\\xampp\\apache_start.bat");
	...
	void GUI()
	{
		...
		lblDevendrLogin = new JLabel("Devendra Login");
		lblDevendrLogin.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblDevendrLogin.setBounds(204, 26, 167, 28);
		contentPane.add(lblDevendrLogin);
